      ...
      <Container maxWidth='lg' sx={{ px: { xs: 2, sm: 3, md: 4 }, pt: { xs: 4, md: 6 } }}>
        ...
        <Box sx={{ mb: 5 }}>
          ...
          <Typography variant='body1' sx={{ color: 'var(--color-muted)', maxWidth: 600 }}>
            Manage your engineering project showcases and technical journal articles directly backed
            by PostgreSQL.
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1 }}>
                ...
                <Typography
                  variant='h6'
                  className='font-serif-display'
                  sx={{ color: 'var(--color-ink)', fontWeight: 600 }}
                >
                  Projects Management
                </Typography>
              </Box>
              <Typography variant='body2' sx={{ color: 'var(--color-muted)' }}>
                View all existing projects, add new system architectures, update code snippets, or
                modify tech stacks.
              </Typography>
            </Box>
          ...
          >
            <Box sx={{ mb: 3 }}>
              ...
              <Typography variant='body2' sx={{ color: 'var(--color-muted)' }}>
                Publish technical writeups, edit Markdown/JSON section structures, and update tags
                and reading times.
              </Typography>
            </Box>
