              ...
              <ScrollReveal key={category.name} variant="zoom-in" delay={idx * 0.12} style={{ height: '100%' }}>
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body2" sx={{ fontSize: '0.9375rem', color: 'var(--color-body)', lineHeight: 1.6, mb: 4 }}>
                    ...
                    <Box component="ul" sx={{ m: 0, p: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 1.5, mb: 2 }}>
                      {category.skills.map((skill) => (
                        <Box component="li" key={skill} sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                          ...
                          <Typography variant="body2" sx={{ fontSize: '0.875rem', color: 'var(--color-body)', fontWeight: 500 }}>
                            {skill}
                          </Typography>
                        </Box>
                      ))}
