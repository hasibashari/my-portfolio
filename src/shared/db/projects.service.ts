...
export async function updateProject(
  ...
  if (updates.badgeColor !== undefined) {
    setClauses.push(`"badgeColor"      = $${p++}`);
    values.push(updates.badgeColor);
  }
